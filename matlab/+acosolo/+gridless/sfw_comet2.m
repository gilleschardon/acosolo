...
function [Xs, amps, v, nu, Pest] = sfw_comet2(Xm, k, Data, Xgrid, Niter, LX, UX)
...
Dgrid = acosolo.utils.normalize(acosolo.sourcemodels.freefield(Xm, Xgrid, k));
...
function [J] = obj_amplitudes(D, Data, x, lbv)
